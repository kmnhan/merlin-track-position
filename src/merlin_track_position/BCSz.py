"""
Copy of the BCSz.py file from the BCS API.

Formatted with ruff from the original file. In case of updates, copy the new BCSz.py
file here and reformat with ruff, then commit.
"""
...
class BCSServer:
    ...
    * **log** (*bool*) - True if the server logged this request.
    ...
    def close_display(self, name="Display Name") -> dict:
        """
        ...
        """
        return self.bcs_request("CloseDisplay", dict(locals()))
    ...
    def get_display_status(self, name="Display Name") -> dict:
        """
        ...
        :return: Dictionary of results, with the following key(s).
            ...
            * **exists** (*list*) - Whether the display is defined to BCS

            * **status** (*list*) - One of {invalid, standard, closed, hidden, minimized, maximized}


        """
        return self.bcs_request("GetDisplayStatus", dict(locals()))
    ...
    def list_displays(self) -> dict:
        ...
        """
        return self.bcs_request("ListDisplays", dict(locals()))
    ...
    def open_display(self, name="Display Name") -> dict:
        """
        Sets the digital output (DO) channel  ``chan`` to ``value``
        ...
        """
        return self.bcs_request("OpenDisplay", dict(locals()))
    ...
    def sc_auto_coll_single_axis_scan(
        self,
        direction="Forward",
        index=0,
        ...
        :type bidirect: bool
        :param ai_for_min_max: Choose what the X Motor does at the scan end.
        :type ai_for_min_max: str
        :param at_end_of_scan:
        :type at_end_of_scan: enum u32
        :param min_max:
        :type min_max: enum u32
        :param description:
        :type description: str
        :param file_pattern:
        :type file_pattern: str
    ...
    def sc_image_single_motor_scan(
        self,
        instrument="",
        save_images_as="",
        x_motor="Select Motor",
        ...
        """
        return self.bcs_request("sc_Image Single Motor Scan", dict(locals()))

    def sc_image_time_scan(
        self,
        instrument="",
        save_images_as="",
        total_time_s=0,
    ...
    def sc_save_trajectory(
        ...
        """
        return self.bcs_request("sc_Save Trajectory", dict(locals()))
    ...
    def sc_single_motor_flying_scan(
        self,
        x_motor="",
        start=0,
        stop=10,
    ...
    def sc_single_motor_relative_scan(
        self,
        x_motor="Select Motor",
        distance=-3,
        current_position=0,
        ...
        """
        return self.bcs_request("sc_Single Motor Relative Scan", dict(locals()))

    def sc_single_motor_scan(
        self,
        x_motor="Select Motor",
        start=-3,
        stop=0,
        ...
        :param ai_for_min_max: Choose what the X Motor does at the scan end.
        :type ai_for_min_max: str
        :param at_end_of_scan: Choose what the scan will do when it finishes.
        :type at_end_of_scan: enum u32
        :param min_max: Choose where the scan will go if moving to min/max
        :type min_max: enum u32
        :param description:
        :type description: str
        :param file_pattern:
